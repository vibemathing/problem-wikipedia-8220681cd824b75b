...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-8220681cd824b75b"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-8220681cd824b75b",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-8220681cd824b75b",
        "url": "https://en.wikipedia.org/wiki/Sumner%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Sumner's conjecture : does every $(2n-2)$ -vertex tournament contain as a subgraph every $n$ -vertex oriented tree?",
      "version": 1
    },
    "title": "Sumner's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "97e7c3aaf0d6373b13ebba27f1288a8a7f4a7977a6211758ecbe9b02b11fd81e"
}
```
